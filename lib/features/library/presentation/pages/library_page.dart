          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(child: _buildNavTab(3, Icons.menu_book_outlined, 'Library', true, () {})),
                Expanded(child: _buildNavTab(4, Icons.smart_display_rounded, 'Media', false, () => context.push(AppRoutes.media))),
              ],
            ),
          ),
          Positioned(
