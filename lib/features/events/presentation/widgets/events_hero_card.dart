...
class EventsHeroCard extends StatelessWidget {
  const EventsHeroCard({super.key, this.onExploreTap});
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Join our exciting events, competitions\nand workshops designed to build\nknowledge and strong values.',
              ...
              child: Stack(
                ...
                children: [
                  Positioned(
                    top: 10,
                    right: 12,
                    child: Icon(Icons.stars_rounded, color: AppColors.gold.withAlpha(160), size: 18),
                  ),
                  Center(
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
